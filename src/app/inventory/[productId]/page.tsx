...
const CategoryModulePage = () => {
  ...
  // const { data: products } = api.module.getCategoriesForModule.useQuery({ moduleId: params?.moduleId });
  const { data: products } = api.inventory.getByCategory.useQuery(params?.productId);

  // console.log("products", params?.categoryId, products[0].id);


  const deleteMutation = api.product.delete.useMutation({
    onSuccess: () => utils.product.getByCategory.invalidate(),
  });
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600">Manage your business inventory</p>
          </div>
          <button
        ...
        {products?.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No Inventory found</h3>
              ...
              >
                ...
                >
                  <div className="flex-1">
                    <img src={prod.metaImage

                      || "/default-module.png"} alt={prod.name} className="w-16 h-16 rounded-full object-cover mb-2" />
                  </div>
