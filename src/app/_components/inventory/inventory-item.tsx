      ...
      <div className="space-y-2.5">
        ...
        <div className="space-y-1.5">
          <div className="flex items-start justify-between gap-2">
            <h3 
              className="text-sm font-bold text-gray-900 group-hover:text-indigo-700 transition-colors duration-300 leading-tight flex-1"
        ...
        {/* Cart Status Indicator - More Compact */}
        {isInCart && (
          <div className="p-1.5 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
            <div className="flex items-center">
            ...
            <FaShoppingCart className="text-green-600 text-xs" />
          </div>
        )}
